...
<body>
	...
	<script type="text/javascript">
		...
		function fn_openFreeBoardWrite() {
			...
			comSubmit.setUrl("<c:url value='/freeboard/openFreeBoardWrite' />");
			comSubmit.submit();
		}
		function fn_openFreeBoardDetail(obj) {
			var comSubmit = new ComSubmit();
			comSubmit
					.setUrl("<c:url value='/freeboard/openFreeBoardDetail' />");
			comSubmit
					.addParam("FREE_NUM", obj.parent().find("#FREE_NUM").val());
			comSubmit.submit();
		}
	</script>
