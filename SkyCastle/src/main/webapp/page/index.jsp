			...
			<div class="col-md-4 col-sm-4">
				<div class="features-content">
					<span class="box1"><span aria-hidden="true"
						class="icon-dial"></span></span>
					<h3>Create An Account</h3>
					<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
						do eiusmod tempor incidid ut labore et dolore magna aliqua.</p>
				</div>
			</div>
					...
					<div class="row">
						...
						<div class="col-md-10 col-sm-10">
							<div class="company-content">
								<h3>
									IOS Developer<span class="full-time">Full Time</span>
								</h3>
								<p>
				...
				<div class="company-list">
					<div class="row">
						...
						<div class="col-md-10 col-sm-10">
							<div class="company-content">
								<h3>
									Back-End developer<span class="part-time">Part Time</span>
								</h3>
								<p>
				...
				<div class="company-list">
					<div class="row">
						...
						<div class="col-md-10 col-sm-10">
							<div class="company-content">
								<h3>
									UI/UX Designer<span class="freelance">Freelance</span>
								</h3>
								<p>
				...
				<div class="company-list">
					<div class="row">
						...
						<div class="col-md-10 col-sm-10">
							<div class="company-content">
								<h3>
									IOS developer<span class="internship">Intership</span>
								</h3>
								<p>
				...
				<div class="company-list">
					<div class="row">
						...
						<div class="col-md-10 col-sm-10">
							<div class="company-content">
								<h3>
									Marketing Holder<span class="full-time">Full Time</span>
								</h3>
								<p>
					...
					<div id="testimonial-slider" class="owl-carousel">
						<div class="testimonial">
							...
							<p class="description">" Lorem ipsum dolor sit amet,
								consectetur adipisicing elit. Autem commodi eligendi facilis
								itaque minus non odio, quaerat ullam unde voluptatum? "</p>
		...
		<div class="copy-right">
			<p>
				&copy;Copyright 2018 Jober Desk | Design By <a
					href="https://localhost:8080/skc/page/index.php">ThemezHub</a>
			</p>
		</div>
	</footer>
