			...
			<form id="fmInsertContent" name="fmInsertContent" enctype="multipart/form-data" method="post">
				...
				<div class="epiWBox">
					...
					<dl class="eptt cf">
						<dt class="req">제목</dt>
						<dd>
							<input type="text" id="ACA_TITLE" name="ACA_TITLE" fieldName="제목" maxlength="100"
					...
					<dl class="warea cf">
						<dt class="req">내용</dt>
						<dd>
							<textarea fieldName="내용" class="__required" id="ACA_BODY" name="ACA_BODY"></textarea>
						</dd>
					</dl>
			<table>
						<tr>
...
function fn_insertAcademyBoard(){ 
	var comSubmit = new ComSubmit("fmInsertContent");  
	comSubmit.setUrl("<c:url value='/academyboard/insertAcademyBoard'/>"); 
	comSubmit.submit();
}
