...
<body>
				...
				<table>
					...
					<tbody>
						<tr>
							...
							<td>${map.STU_NUM } 
							<input type="hidden" id="STU_NUM" name="STU_NUM" value="${map.STU_NUM }">
						...
						<tr>
							<th scope="row">제목</th>
							<td><colspan="3">
							<input type="text" id="STU_TITLE" name="STU_TITLE" class="wdp_90" value="${map.STU_TITLE }"/>

						</tr>
						<tr>
							<td colspan="4" class="view_text"> 
							<textarea rows="20" cols="100" title="내용" id="STU_BODY" name="STU_BODY">${map.STU_BODY }</textarea>
	...
	<div class="container">
		<div class="btn_type_03">
			...
			<span>Back To StudentBoard</span>
			</a> 
...
<script type="text/javascript"> 
	$(document).ready(function(){ 
		...
		e.preventDefault(); 
		fn_updateStudentBoard(); 
	}); 
		$("#delete").on("click", function(e){ //삭제하기 버튼
		e.preventDefault();
		fn_deleteStudentBoard();
	});
	});
	...
	function fn_updateStudentBoard(){ 
	var comSubmit = new ComSubmit("frm"); 
	comSubmit.setUrl("<c:url value='/studentboard/updateStudentBoard' />");
	
	comSubmit.submit();
	} 
	function fn_deleteStudentBoard(){ 
	var comSubmit = new ComSubmit(); 
	comSubmit.setUrl("<c:url value='/studentboard/deleteStudentBoard' />"); 
	comSubmit.addParam("STU_NUM", $("#STU_NUM").val()); 
	comSubmit.submit(); 
	}
