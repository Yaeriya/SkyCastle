...
<body>
	<div id="wrap">
		...
		<hr text-align="center" style="display: block; width:1140px; margin:auto;"  />
		<br />
		<br />
        <br />
		...
		<c:if test="">
	       ...
	       <c:url var="viewURL" value="../join/login.jsp"></c:url>
			  <a href="../join/login.jsp"><font style="float: center" size="4px">*로그인 후에 댓글 작성이 가능합니다</font></a>
		</c:if>
		</div>
		<c:if test="">
			...
			<form action="" method="post"
				onsubmit="return validateForm()" name="commentForm">
      <br/>
				<div class="reply_grp">
					...
					<div class="reply_form">
						<div class="reply_inp">
							...
							<input type="hidden" name="no" value="${reviewCoModel.no}" />
						</div>
