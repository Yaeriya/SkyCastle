...
<div id="whole">
	...
	<form id="fmInsertContent" name="fmInsertContent"
		 action="myqna_create_action.asp"
		target="_iFrmForAction" method="post"
		onsubmit="return validateFormElement(this);">
		
		<p class="k1">쿠폰 사용 신청</p>
		<p class="p2" style="margin-bottom: 39px; line-height: 26px;">
			쿠폰 사용 신청을 남겨주시면 신속히 답변 드리겠습니다.<br /> <span
				style="color: red;">※ 수강 중일 때만 교안 다운로드 서비스가 지원됩니다.</span><br /> (수강
			종료 직전 또는 종료 후에 교안 다운로드 요청은 지원 불가)<br /> <span style="color: red;">※
				1개월 프리패스 수강 시 교안을 요청하실 경우, 수강하시는 세부 과목명을 정확하게 적어주세요.</span>
		</p>
		<table>
			...
			<tr>
				...
				<td class="z2 z0 z2">
					<div id="select_box">
						<label for="color">신청할 학원 선택</label> 
						<select name="course_name" id="color" title="select color">
