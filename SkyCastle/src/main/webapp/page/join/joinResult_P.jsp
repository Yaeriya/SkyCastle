...
<body>
	...
	<nav class="navbar navbar-default navbar-sticky bootsnav">
		...
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.jsp"><img src="/skc/img/logo.png"
					class="logo" alt=""></a>
			</div>
	...
	<script type="text/javascript" src="/skc/jquery.min.js"></script>
	<script src="/skc/js/bootstrap.min.js"></script>
	<script type="text/javascript" src="/skc/owl.carousel.min.js"></script>
